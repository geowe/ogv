...
class SimpleLayerLegend extends LayerLegend {
    constructor() {
        super({ id: 'simpleLayerLegend', parent: document.body });
    ...
    addItem(item, layerName) {
        ...
        if (this._itemCount !== null) {
            this._legendContent.appendChild(this.getLayerTotalFeaturesLabel());
        }
    ...
    getLayerZoomTool(layerName) {
        ...
        zoomToLayerElement.onclick = () => {
            this._map
                .getView()
                .fit(this._layers[layerName].getSource().getExtent(), {
