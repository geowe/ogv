...
export class HeatLayer extends BaseLayer {
    ...
    prepareFeatures() {
        ...
        this._features.forEach((feature) => {
            ...
            if (geom.getType() === 'Polygon') {
                ...
                feature.setGeometry(new Point(geom.getFirstCoordinate()));
            }
        });
    }
    ...
    createLayer(features, isDefaultColors, blur, radius) {
        ...
        if (isDefaultColors) {
            ...
            for (var i = 0; i < TOTAL_COLOR_PALETTE; i++) {
                gradient.push(this._style.getHexNextColor());
            }
        }
